          ...
          >
            {visibleCards.map((article, idx) => (
              <motion.a
                ...
                whileHover={{ y: -4 }}
                className="group block bg-[#3a3a3a] rounded-2xl overflow-hidden border border-white/10 shadow-lg hover:shadow-[0_20px_50px_rgba(255,140,0,0.15)] transition-shadow duration-400 cursor-pointer"
              >
                {/* Image */}
