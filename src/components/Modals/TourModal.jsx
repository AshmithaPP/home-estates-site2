        ...
        >
          ...
          {!submitted ? (
            <div>
              ...
              <h2 className="text-xl sm:text-2xl font-bold uppercase tracking-tight mb-2">Schedule Your Private Tour</h2>
            ...
            <div className="py-8 text-center space-y-4">
              ...
              <h3 className="text-2xl font-black uppercase text-white">Tour Confirmed!</h3>
