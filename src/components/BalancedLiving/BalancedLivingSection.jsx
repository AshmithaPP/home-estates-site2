        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 lg:gap-5 pt-2 items-stretch w-full">
          {floorplansData.map((plan, idx) => (
            <motion.div
              ...
              className="bg-[#3a3a3a] p-3.5 sm:p-4 rounded-2xl shadow-[0_12px_30px_rgba(0,0,0,0.3)] hover:shadow-[0_22px_45px_rgba(255,140,0,0.2)] border border-white/10 flex flex-col justify-between transition-shadow duration-300 cursor-pointer group"
            >
